...
class AuthorizationServiceTest {
    ...
    void approvesTransactionFromActiveAssignedTpe() {
        ...
        TransactionMonetique result = service.autoriserTransactionTpe(
            "TPE-001", new BigDecimal("125.50"), TypeTransaction.ACHAT, "000001", "123456789012", true, false);
    ...
    void refusesUnknownOrUnassignedTpe() {
        ...
        TransactionMonetique result = service.autoriserTransactionTpe(
            "TPE-002", BigDecimal.TEN, TypeTransaction.ACHAT, "000002", "123456789013", true, false);
    ...
    void refusesExpiredCardAndExceededDailyLimit() {
        ...
        TransactionMonetique expired = service.autoriserTransactionTpe(
            "TPE-003", BigDecimal.TEN, TypeTransaction.ACHAT, "000003", "123456789014", true, true);
        ...
        TransactionMonetique overLimit = service.autoriserTransactionTpe(
            "TPE-003", new BigDecimal("20"), TypeTransaction.ACHAT, "000004", "123456789015", true, false);
    ...
    void refusesInvalidCardAndSuspiciousVelocity() {
        ...
        TransactionMonetique invalidCard = service.autoriserTransactionTpe(
            "TPE-004", BigDecimal.TEN, TypeTransaction.ACHAT, "000005", "123456789016", false, false);
        ...
        TransactionMonetique suspicious = service.autoriserTransactionTpe(
            "TPE-004", BigDecimal.TEN, TypeTransaction.ACHAT, "000006", "123456789017", true, false);
    ...
    void refusesInactiveAndMissingTerminals() {
        ...
        assertEquals("05", service.autoriserTransactionTpe(
            "TPE-005", BigDecimal.ONE, TypeTransaction.ACHAT, "000007", "123456789018", true, false
        ).getCodeReponse());
        assertEquals("05", service.autoriserTransactionTpe(
            "MISSING", BigDecimal.ONE, TypeTransaction.ACHAT, "000008", "123456789019", true, false
        ).getCodeReponse());
    }
